...
use super::loader::*;
use super::types::{Instruction, Quiet, Signaling};
use super::Result;
use tycho_types::prelude::CellSlice;

pub(super) type LoadHandler = fn(&mut Loader, &mut CellSlice) -> Result<Instruction>;
...
impl Handlers {
    ...
    pub(crate) fn get_handler(&self, slice: &mut CellSlice) -> Result<LoadHandler> {
        let cmd = slice.load_u8()?;
